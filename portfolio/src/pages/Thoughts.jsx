		...
		<Container>
			...
			<div className="featured-opinions roboto">
				<article className="article">
					<a href="www.google.com" target="_blank" rel="noreferrer"><img alt="Cover of Macbook Pro with V S  Code open." className="article-image" src="./assets/arnold-francisca-unsplash.jpg" />
			...
			<h2 className="section-heading montserrat fw-bold color-font">MORE THOUGHTS</h2>

...
const introText = "Maria is a versatile professional at the intersection of UX design and frontend development. Her diverse background in finance, coupled with international experience, equips her with a unique perspective. She has a deep-rooted passion for technology with the mission is to create seamless, user-centric digital solutions that bridge the gap between finance and innovation.";

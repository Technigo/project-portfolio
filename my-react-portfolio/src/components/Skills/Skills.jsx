...
export const Skills = () => {
    return (
      <div className="skills-container">
          ...
          <p className="small-text">Adobe Illustrator</p>
          ...
          <p className="small-text">Process design</p>
          <p className="small-text">Concept development</p>
          <p className="small-text">Agile methodology</p>
          <p className="small-text">Hyper Island toolbox</p>
      </div>
    );
  }
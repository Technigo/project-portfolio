      ...
      <div className="skills-wrapper">
        ...
        <div className="skills-container">
          <div className="text-box">
            <h4 className="skill-headline code-headline">Code</h4>
          ...
          <div className="text-box">
            <h4 className="skill-headline toolbox-headline">Toolbox</h4>
          ...
          <div className="text-box">
            <h4 className="skill-headline upcoming-headline">Upcoming</h4>
            <p className="skills-p">Unclear</p>
          </div>

          <div className="text-box">
            <h4 className="skill-headline more-headline">More</h4>

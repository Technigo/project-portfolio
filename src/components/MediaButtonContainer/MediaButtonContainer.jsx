...
export const MediaButtonContainer = () => {
    return (
        <div className="media-button-container">
            <MediaButton src={BtnLinkedin} alt="LinkedIn Button"></MediaButton>
            <MediaButton src={BtnGithub} alt="GitHub Button"></MediaButton>
            <MediaButton src={BtnStackoverflow} alt="Stackoverflow Button"></MediaButton>
            <MediaButton src={BtnTwitter} alt="Twitter Button"></MediaButton>
            <MediaButton src={BtnInstagram} alt="Instagram Button"></MediaButton>
        </div>
    )
}
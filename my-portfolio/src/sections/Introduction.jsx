    ...
    <section className="intro-container">
      ...
      <div className="intro-text-box">
        <p>
          ...
          <br />
          With a background in retail and in warehouse as an operation manager, i&apos;ve always enjoyed and been driven
          to find solutions and create sustainable methods to prevent future errors. Being a frontend developer I&apos;m
          able to do the things I really like to do - be creative, organise and create reliable methods.
        </p>
      </div>

...
const projects = [
    {
    lottie: "https://assets5.lottiefiles.com/private_files/lf30_tvtymgdi.json",
    ...
    {
    lottie: "https://assets9.lottiefiles.com/private_files/lf30_aujbnxbu.json",
    ...
    {
    lottie: "https://assets9.lottiefiles.com/packages/lf20_sGELgjjeiG.json",
    ...
    {
    lottie: "https://assets5.lottiefiles.com/packages/lf20_8stPs6zpUO.json",
    title: "Project To-do",
    ...
    {
    lottie: "https://assets9.lottiefiles.com/packages/lf20_yyoJKd.json",
    ...
    {
    lottie: "https://assets3.lottiefiles.com/packages/lf20_tkB6JA8wOD.json",
...
projects.forEach((project) =>{
    ...
    <section class="project">
        ...
        <section class="project-content">
            ...
            <p><span class="tags">${project.tech}</span></p>
                <section class="featured-buttons">
